...
export const LoginModal: FC<LoginModalProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 overflow-auto">
      <div className="bg-black w-full max-w-md p-6 rounded-md shadow-lg relative z-10 ">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full bg-white text-black py-2 rounded hover:bg-black cursor-pointer"
          >
            Log In
          </button>
        </form>
